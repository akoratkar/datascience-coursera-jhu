---
title: "Coursera Practical Machine Learning - Final Project Desertation"
author: "AK" 
date: "03/22/2016"
output: 
  html_document:
...
```
- The accuracy of the random forest model is **`r rforestConfMatrix$overall['Accuracy']`** and the sample error is **`r 1-rforestConfMatrix$overall['Accuracy']`**
